...
//console.log('timeupdate'+currentTimeIndex+' '+parag.length)
update(arguments);
...
console.log("1");
seekToP = 0;
isPlayerFirstTime = true;

seekTo(seekToP,myTimes[pagenumber-1]);

console.log("2z");
//setTimeout(console.log("rr"),2000);
//populatearrays();
...
console.log('monocle:chapterSrc  chapterSrc' +chapterSrc );
...
console.log('move to chapter '+Get_Cookie('currentChapterSource'));
